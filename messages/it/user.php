...
return [
    ...
    'Account details have been updated' => 'I dettagli dell&rsquo;account sono stati aggiornati',
    ...
    'VKontakte' => 'VKontakte',
    'Yandex' => 'Yandex',
    'You can assign multiple roles or permissions to user by using the form below' => 'Puoi assegnare pi&ugrave; ruoli o permessi ad un utente usando il modulo sottostante',
    'You can connect multiple accounts to be able to log in using them' => 'Poi connettere pi&ugrave; account ed usarli per per effettuare l&rsquo;accesso',
    ...
    'A new confirmation link has been sent' => 'Un nuovo collegamento di attivazione &egrave; stato inviato',
    ...
    'An email has been sent with instructions for resetting your password' => '&Egrave; stata inviata un&rsquo;email con le istruzioni per il reset della password',
    'An error occurred and your password has not been changed. Please try again later.' => 'C&rsquo;&egrave; stato un errore e la tua password non &egrave; stata cambiata. Per 
    favore, riprova pi&ugrave; tardi.',
    'An error occurred processing your request' => 'C&rsquo;&egrave; stato un errore nell&rsquo;elaborazione della tua richiesta',
    'Are you sure you want to block this user?' => 'Sicuro di voler bloccare questo utente?',
    'Are you sure you want to confirm this user?' => 'Sicuro di voler attivare questo utente?',
    'Are you sure you want to unblock this user?' => 'Sicuro di voler sbloccare questo utente?',
    'Are you sure? Deleted user can not be restored' => 'Sei sicuro? L&rsquo;utente non potr&agrave; essere ripristinato',
    ...
    'Confirm' => 'Conferma',
    'Confirm account on {0}' => 'Conferma l&rsquo;account su {0}',
    ...
    'Credentials will be sent to the user by email' => 'Le credenziali verranno inviate all&rsquo;utente via email',
    ...
    'Error occurred while confirming user' => 'Si &egrave; verificato un errore durante la conferma dell&rsquo;utente',
    'Error occurred while deleting user' => 'Si &egrave; verificato un errore durante la cancellazione dell&rsquo;utente!',
    'Finish' => 'Completa',
    ...
    'If you cannot click the link, please try pasting the text into your browser' => 'Se hai problemi, per favore prova ad incollare l&rsquo;URL sopra nella barra degli indirizzi',
    ...
    'Invalid login or password' => 'Login o Password errata',
    ...
    'Please click the link below to complete your password reset' => 'Clicca sul link qui sotto per completare la reimpostazione della password',
    ...
    'Registration ip' => 'IP di registrazione',
    'Registration time' => 'Data di registrazione',
    ...
    'Sign in' => 'Accedi',
    'Sign up' => 'Registrati',
    'Something went wrong and your account has not been confirmed.' => 'Qualcosa &egrave; andato storto e il tuo account non &egrave; stato attivato.',
    ...
    'There is no user with this email address' => 'Non esiste alcun utente con questa email',
    'This account has already been confirmed' => 'Questo account &egrave; gi&agrave; stato attivato',
    'This account has already been connected to another user' => 'Questo account &egrave; gi&agrave; stato collegato ad un altro utente',
    ...
    'User has been blocked' => 'L&rsquo;utente &egrave; stato bloccato',
    'User has been confirmed' => 'L&rsquo;utente &egrave; stato attivato',
    'User has been created' => 'L&rsquo;utente &egrave; stato creato',
    'User has been deleted' => 'L&rsquo;utente &egrave; stato rimosso',
    'User has been unblocked' => 'L&rsquo;utente &egrave; stato sbloccato',
    ...
    'Your account has been created' => 'Il tuo account &egrave; stato creato',
    'Your account on {0} has been created' => 'Il tuo account su {0} &egrave; stato creato',
    'Your confirmation token is invalid or expired' => 'Il tuo codice di conferma non &egrave; valido o &egrave; scaduto',
